...
public class chatbot extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnAprendizagem.setText("Cadastros");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/download.jpg"))); // NOI18N

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 22)); // NOI18N
        jLabel1.setText("Seja Bem vindo ao Serviço de atendimento da Philips Clinical Informatics! ");
        ...
        txtFrase.setNextFocusableComponent(txtFrase);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(txtFrase, javax.swing.GroupLayout.PREFERRED_SIZE, 360, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAprendizagemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAprendizagemActionPerformed
        apendizagem ap = new apendizagem();
        ap.setVisible(true);
    }//GEN-LAST:event_btnAprendizagemActionPerformed

    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        if (txtFrase.getText().equals("")) {
            JOptionPane.showMessageDialog(jMenu1, evt, "Atenção", WIDTH);
        } else {
            areaConversa.append("Você: " + txtFrase.getText() + "\n");
            func.resposta(areaConversa, func.fraseDividida(func.tirarEspeciais(txtFrase.getText())));
            txtFrase.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(chatbot.class
